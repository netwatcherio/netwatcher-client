...
<!--                <div class="mb-1 col-lg-4 col-8">
                  <br>
                  &lt;!&ndash;                  <div v-if="state.selected.value === 'MTR' || 'PING' || 'RPERF' && state.agentGroups.length > 0">
                  ...
                  &lt;!&ndash;                  <div class="mt-3">Selected: <strong>{{ state.selected }}</strong></div>&ndash;&gt;
                </div>-->
              </div>
              <br>
<!--              <div class="row">
                <div v-if="state.selected && state.selected.value">
                  ...
                  &lt;!&ndash; MTR Options &ndash;&gt;
                  &lt;!&ndash;                <div v-if="state.targetGroup">
                                    <div class="mb-3 col-lg-8 col-12">
                  ...
                  <div v-if="state.selected.value === 'TRAFFICSIM'">
                    &lt;!&ndash; Fields specific to MTR &ndash;&gt;
                  ...
                  <div v-if="state.selected.value === 'RPERF'">
                    ...
                    &lt;!&ndash;                    <div class="mb-3" v-if="state.customRperfServer && !state.targetGroup && !state.targetAgent ">
                  ...
                  &lt;!&ndash; PING Options &ndash;&gt;
                  <div v-if="state.selected.value === 'PING'">
                    &lt;!&ndash; Fields specific to PING &ndash;&gt;
                  ...
                  &lt;!&ndash; SPEEDTEST Options &ndash;&gt;
                  <div v-if="state.selected.value === 'SPEEDTEST'">
                    &lt;!&ndash; Fields specific to SPEEDTEST &ndash;&gt;
                  </div>

                  &lt;!&ndash; MTR Options &ndash;&gt;
                  <div v-if="state.selected.value === 'MTR'">
                    &lt;!&ndash; Fields specific to RPERF &ndash;&gt;
                    <div v-if="!state.targetGroup && !state.targetAgent" class="mb-3">
